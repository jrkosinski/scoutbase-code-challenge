 ...
 * ------------------------
 * sets up the GraphQL server with schema, typedefs, resolvers and such.
 *
...
/**
 * sets up an ApolloServer with typedefs and schema, and returns it.
 *
 * @returns {ApolloServer} an instance of the server itself, to be included as
